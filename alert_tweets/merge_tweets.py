...
for keyword in keywords:
    keyword
    try:
        df = pd.read_csv('./alert_tweets/alert_keyword_tweets/' + str(keyword) + '_tweets.csv')
...
tweets1.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location1.csv', index=False)
tweets2.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location2.csv', index=False)
tweets3.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location3.csv', index=False)
tweets4.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location4.csv', index=False)
tweets5.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location5.csv', index=False)
tweets6.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location6.csv', index=False)
tweets7.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location7.csv', index=False)
tweets8.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location8.csv', index=False)
tweets9.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location9.csv', index=False)
tweets10.to_csv('./suicidal_tweets/alert_tweets_with_location_split/alert_tweets_with_location10.csv', index=False)
...
for keyword in keywords:
    keyword
    try:
        df = pd.read_csv('./medication_tweets/medication_keyword_tweets/' + str(keyword) + '_tweets.csv')
...
tweets.to_csv('./medication_tweets/medication_tweets_with_locations.csv', index=False)